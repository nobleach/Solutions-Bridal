...
CREATE TABLE `collections` (
  ...
  `col_desc` text,
  `col_url` varchar(120) DEFAULT NULL,
  PRIMARY KEY (`col_id`)
...
INSERT INTO `collections` (`col_id`,`col_type`,`col_name`,`col_desc`,`col_url`) VALUES 
 ...
 (8,'bridal','Mikaella','																								Mikaella designer Paloma Blanca has been producing exceptional bridal gowns since 1937. With Mikaellaï¿½s launch in 2004, these gowns were to designed to provide the bridal industry with a high quality product at an attractive price. A Mikaella gown is perfect for a classic bride with a modern 21st century flair. 																					',NULL),
 (9,'bridal','Kenneth Poole','								Founded in 2003 by Amsale Aberra, the Kenneth Pool collection is known for its sexy and unapologetic glamour. This label has long been recognized for its embodiment of drama, luxurious fabrics, and exquisite beadwork. The Kenneth Pool collection allows Aberra to show off her creativity with elaborate fashion. A Kenneth Pool gown is perfect for a bride who commands the spotlight. 							',NULL),
 (10,'bridal','Romona Keveza','Coming Soon.',NULL),
 (11,'bridal','Amy Michelson','																Coming Soon.														',NULL),
 (12,'bridal','Lazaro','								Lazaro, former artist, has transformed his works into bridal gown masterpieces. Avoiding trends, Lazarro blends ultra-glamorous vintage details and floral embellishments into his collections. The Lazaro gown ranges from simple silhouettes to extravagant ball gowns and is perfect for a feminine bride. 							',NULL),
 (13,'ATTENDANTS','Watters & Watters','																																													',NULL),
 (14,'ATTENDANTS','The Dessy Group','																Coming Soon.														',NULL),
 ...
 (30,'ACCESSORIES','Spanx by Sarah Barkeley','																				',NULL);
...
INSERT INTO `realbrides` (`bride_id`,`bride_name`,`bride_img`) VALUES 
 (4,'Ashley Hall','g_5665653272100037436.jpg'),
 (5,'Courtney Parks','g_528662216168147550.jpg'),
 (6,'Ada Bazin','g_3437520421708768596.jpg'),
 (7,'Amber Purser','g_1982171035581660431.jpg'),
 (8,'Betsy Wright','g_5753439371280028733.jpg'),
 (9,'Christine Durrance','g_16395239362098589874.jpg'),
 (10,'Jamee Miller','g_13945251982120003710.jpg'),
 (11,'Jane Long','g_1966800005888555930.jpg'),
 (12,'Jennifer Capri','g_1184217326125758861.jpg'),
 (13,'Joan Green','g_711881294640725618.jpg'),
 (14,'Julie Jones','g_1378663324924462796.jpg'),
 (15,'Kaitlin Poirier','g_76387913921762480.jpg'),
 (16,'Nicole Trusty','g_12217575602098381601.jpg'),
 (17,'Niki Schrader','g_2145302589274949092.jpg'),
 (18,'Rebecca Koegel','g_725124970516217081.jpg'),
 (19,'Sarah McBride','g_1864993181715448326.jpg'),
 (20,'Tandra Mackail','g_10620967901976492433.jpg'),
 (21,'Jana from XL 106.7 ','g_819491390982688717.jpg');
